...
import { MedicineProfitDTO } from '../../dtos/medicine-profit-dto';
import { MedicineProfitService } from '../../services/medicine-profit.service';
import { ActivatedRoute, RouterLink } from '@angular/router';
import { FormsModule } from '@angular/forms';
import { CommonModule, Location } from '@angular/common';
import { MedicineSaleDTO } from '../../dtos/medicine-sale-dto';
...
export class MedicineProfitDetailComponent implements OnInit {
  ...
  medicineSale: MedicineSaleDTO | undefined; // To hold sale details
  loading = true;
  error = '';
  ...
  private medicineSaleService = inject(MedicineSaleService); // Inject MedicineSaleService
    ...
    this.medicineProfitService.getById(id).subscribe({
      next: (data) => {
        ...
        if (data.medicineSaleId) {
          this.loadMedicineSale(data.medicineSaleId); // Load sale details if sale ID exists
        } else {
          this.loading = false;
        }
      },
